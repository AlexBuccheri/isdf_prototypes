"""
This module has been copied and pasted from https://github.com/jensengroup/xyz2mol/blob/master/xyz2mol.py
No idea why Jan doesn't try to merge this upstream rather than distributing as a separate package
